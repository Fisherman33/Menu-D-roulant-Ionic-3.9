...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.time = function () {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_data_service_data_service__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_data_service_data_service__ = __webpack_require__(99);
...
var DataServiceProvider = /** @class */ (function () {
    ...
    DataServiceProvider.prototype.getData = function (dataM) {
        var _this = this;
        return new Promise(function (resolve) {
            var url = "././../assets/data/listMenu.json";
    ...
    DataServiceProvider.prototype.getDataT = function (dataTime) {
        var _this = this;
        return new Promise(function (resolve) {
            var url = "././../assets/data/listTime.json";
            _this.http.get(url).map(function (res) { return res.json(); }).subscribe(function (data) {
                console.log(data);
                resolve(data);
            }, function (err) {
